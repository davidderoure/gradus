...
with open("/Users/davidderoure/gradus/bfile_superparticular.txt", "w") as f:
    f.write("# a(n) = n + Omega*(n-1), n >= 2\n")
    f.write("# Two-stage dissonance of superparticular interval n/(n-1)\n")
