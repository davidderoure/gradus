...
Section~10 presents the triangle $T(n,k)$ and proposed OEIS sequences,
and concludes.
...
and gives rise to two proposed OEIS entries.
...
(v)~the coprime integer triangle $T(n,k)$ and its superparticular diagonal as
